...
2. **Гибридный поиск:** Внедрен FAISS + BM25 + RRF, поднявший Context Recall с 0.50 до 0.59 (+18%).
...
|---|---|---|---|
| **Context Recall** | 0.500 | **0.590** | **+0.090 (+18%)** 🚀 |
| **Faithfulness** | 0.711 | 0.585 | -0.126 (-18%) ⚠️ |

**Вывод:** Гибридный поиск успешно решил проблему лексического разрыва, но потребовал балансировки (см. Roadmap ниже).
...
*Проект готов к демонстрации на собеседовании Middle+/Senior ML Engineer.*
